...
--
-- Servidor: localhost
-- Tiempo de generación: 05-09-2018 a las 10:03:43
...
--
-- Base de datos: `bd_participacion`
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `catalogo_area`
--
...
--
-- Volcar la base de datos para la tabla `catalogo_area`
--

INSERT INTO `catalogo_area` (`cta_id`, `cta_nombre`, `cta_descripcion`, `cta_estado`, `cta_eliminado`) VALUES
...
--
-- Estructura de tabla para la tabla `catalogo_fase`
--
...
CREATE TABLE IF NOT EXISTS `catalogo_fase` (
  ...
  PRIMARY KEY (`ctf_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Contiene el Catalogo de Fases del Proceso de Participacion' AUTO_INCREMENT=6 ;

--
-- Volcar la base de datos para la tabla `catalogo_fase`
--

INSERT INTO `catalogo_fase` (`ctf_id`, `ctf_nombre`, `ctf_descripcion`, `ctf_estado`, `ctf_orden`, `ctf_eliminado`) VALUES
...
--
-- Estructura de tabla para la tabla `catalogo_metodo`
--
...
--
-- Volcar la base de datos para la tabla `catalogo_metodo`
--

INSERT INTO `catalogo_metodo` (`ctm_id`, `ctm_nombre`, `ctm_descripcion`, `ctm_imagen`, `ctm_id_nivel`, `ctm_estado`, `ctm_eliminado`) VALUES
...
CREATE TABLE IF NOT EXISTS `catalogo_nivel` (
  ...
  PRIMARY KEY (`ctn_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Catalogo Nivel de Participación ' AUTO_INCREMENT=5 ;

--
-- Volcar la base de datos para la tabla `catalogo_nivel`
--

INSERT INTO `catalogo_nivel` (`ctn_id`, `ctn_nombre`, `ctn_descripcion`, `ctn_estado`, `ctn_eliminado`) VALUES
...
--
-- Estructura de tabla para la tabla `catalogo_tarea`
--
...
CREATE TABLE IF NOT EXISTS `catalogo_tarea` (
  ...
  PRIMARY KEY (`ctt_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla del Catalogo de Tareas' AUTO_INCREMENT=4 ;

--
-- Volcar la base de datos para la tabla `catalogo_tarea`
--

INSERT INTO `catalogo_tarea` (`ctt_id`, `ctt_nombre`, `ctt_descripcion`, `ctt_estado`, `ctt_orden`, `ctt_eliminado`) VALUES
...
--
-- Estructura de tabla para la tabla `catalogo_tipo_participante`
--
...
CREATE TABLE IF NOT EXISTS `catalogo_tipo_participante` (
  ...
  PRIMARY KEY (`ctp_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla de Catalogo de Tipo de Participante' AUTO_INCREMENT=5 ;

--
-- Volcar la base de datos para la tabla `catalogo_tipo_participante`
--

INSERT INTO `catalogo_tipo_participante` (`ctp_id`, `ctp_nombre`, `ctp_descripcion`, `ctp_estado`, `ctp_eliminado`) VALUES
...
--
-- Estructura de tabla para la tabla `catalogo_tipo_usuario`
--
...
CREATE TABLE IF NOT EXISTS `catalogo_tipo_usuario` (
  ...
  PRIMARY KEY (`cau_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla Catalogo Tipo de Usuario' AUTO_INCREMENT=5 ;

--
-- Volcar la base de datos para la tabla `catalogo_tipo_usuario`
--

INSERT INTO `catalogo_tipo_usuario` (`cau_id`, `cau_nombre`, `cau_descripcion`, `cau_estado`, `cau_eliminado`) VALUES
...
INSERT INTO `criterio` (`cri_id`, `cri_nombre`, `cri_indicador`, `cri_rango`, `cri_id_fas`) VALUES
(1, 'hola', 'hola', 'hola', 69),
(2, 'hola', 'hola', 'hola', 69),
(3, '', 'prueba', 'prueba', 71);
...
INSERT INTO `fase` (`fas_id`, `fas_nombre`, `fas_descripcion`, `fas_objetivo`, `fas_fecha_inicio`, `fas_fecha_fin`, `fas_orden`, `fas_tipo`, `fas_estado`, `fas_eliminado`, `fas_id_pro`) VALUES
...
INSERT INTO `metodo` (`mep_id`, `mep_id_proceso`, `mep_id_metodo`, `mep_estado`, `mep_eliminado`) VALUES
(10, 35, 6, 'Activo', 0),
(11, 35, 7, 'Activo', 0),
(12, 35, 11, 'Activo', 0),
(39, 45, 6, 'Activo', 0),
...
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 COMMENT='Tabla Participante del Proceso' AUTO_INCREMENT=13 ;

--
-- Volcar la base de datos para la tabla `participante`
--

INSERT INTO `participante` (`par_id`, `par_nombre`, `par_email`, `par_predefinido`, `par_estado`, `par_eliminado`, `par_id_usu`, `par_id_tip`) VALUES
...
--
-- Estructura de tabla para la tabla `participante_proceso`
--
...
--
-- Volcar la base de datos para la tabla `participante_proceso`
--

INSERT INTO `participante_proceso` (`pra_id`, `pra_id_proceso`, `pra_id_participante`, `pra_estado`, `pra_eliminado`) VALUES
(25, 35, 3, 'Inactivo', 0),
(26, 35, 4, 'Activo', 0),
(27, 35, 7, 'Activo', 0),
(39, 45, 3, 'Inactivo', 0),
...
INSERT INTO `proceso` (`pro_id`, `pro_titulo`, `pro_subtitulo`, `pro_descripcion`, `pro_objetivo`, `pro_alcance`, `pro_fecha_inicio`, `pro_fecha_fin`, `pro_estado`, `pro_eliminado`, `pro_id_area`, `pro_id_usuario`) VALUES
...
INSERT INTO `tarea` (`tar_id`, `tar_nombre`, `tar_descripcion`, `tar_fecha_inicio`, `tar_fecha_fin`, `tar_orden`, `tar_tipo`, `tar_estado`, `tar_eliminado`, `tar_id_fase`) VALUES
...
INSERT INTO `usuario` (`usu_id`, `usu_usuario`, `usu_email`, `usu_clave`, `usu_estado`, `usu_eliminado`, `usu_id_tipo_usuario`) VALUES
...
--
-- Filtros para la tabla `catalogo_metodo`
--
...
--
-- Filtros para la tabla `participante_proceso`
--
