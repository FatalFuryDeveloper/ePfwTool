...
######################################################################
    ...
    function consultar(){
        ...
        $resultado  = mysqli_query($conexion,"SELECT * FROM catalogo_area WHERE cta_eliminado='$eliminado' ORDER BY cta_nombre ASC");
    ...
    function insertar(){
        ...
        $estado     = $data["estado"];
        $eliminado  = $data["eliminado"];
        $resultado  = mysqli_query($conexion,"INSERT INTO catalogo_area (cta_nombre, cta_descripcion, cta_estado, cta_eliminado) VALUES ('$nombre', '$descripcion', '$estado', '$eliminado') ");
