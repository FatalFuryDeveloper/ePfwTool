<?php
    ...
    function consultar(){
		...
		$resultado= mysql_query("SELECT * FROM usuario, catalogo_tipo_usuario WHERE usu_id_tipo_usuario=cau_id AND usu_eliminado='$eliminado'");
	...
	function consultarUsuario(){
		...
		$resultado  = mysql_query("SELECT * FROM usuario WHERE usu_email='$usuario' AND usu_clave='$password' ");
		codificarJSON($resultado);
	}
	...
	function consultarUsuarioEspecifico(){
		global $conexion, $data;
		$id 	= $data["id"];
		$resultado  = mysql_query("SELECT * FROM usuario WHERE usu_id='$id'");
		codificarJSON($resultado);
	}
	...
	function consultarEmailUsuario(){
		global $conexion, $data;
		$email 	= $data["email"];
		$resultado  = mysql_query("SELECT * FROM usuario WHERE usu_email='$email'");
		codificarJSON($resultado);
	}
	...
	function insertar(){
		...
		$eliminado 	= $data["eliminado"];
		$estado 	= $data["estado"];
		$resultado  = mysql_query("INSERT INTO usuario(usu_usuario, usu_email, usu_clave, usu_estado, usu_eliminado, usu_id_tipo_usuario)VALUES ('$usuario', '$email', '$clave', '$estado', '$eliminado', '$tipo' ) ");
		validarError();
	}
	...
	function modificar(){
		...
		$tipo		= $data["tipo"];
		$estado 	= $data["estado"];
		$resultado 	= mysql_query("UPDATE usuario SET usu_clave='$clave', usu_id_tipo_usuario='$tipo', usu_estado='$estado' WHERE usu_id='$id'");
		validarError();
	}
	...
	function modificarUsuario(){
		...
		$email 		= $data["email"];
		$clave		= $data["clave"];
		$resultado 	= mysql_query("UPDATE usuario SET usu_usuario='$usuario', usu_clave='$clave' WHERE usu_id='$id'");
		validarError();
	}
	...
	function cambiarEstado(){
		...
		$id 		= $data["id"];
		$estado		= $data["estado"];
		$resultado 	= mysql_query("UPDATE usuario SET usu_estado='$estado' WHERE usu_id='$id'");
		validarError();
	}
	...
	function eliminar(){
		...
		$id 		= $data["id"];
		$eliminado 	= $data["eliminado"];
		$resultado 	= mysql_query("UPDATE usuario SET usu_eliminado='$eliminado' WHERE usu_id='$id'");
		validarError();
	}
