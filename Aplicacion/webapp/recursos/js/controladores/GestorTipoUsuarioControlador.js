/**
 * @type    controller
 * @name    GestorTipoUsuarioControlador
...
(function(angular) {
    ...
    angular.module('sri').controller('GestorTipoUsuarioControlador',GestorTipoUsuarioControlador);

    /* Parametros a inyectar en la Funcion Principal*/
    GestorTipoUsuarioControlador.$inject = ['$rootScope', '$scope', '$uibModal', '$state', '$translate', '$timeout',
        'I18nFactory', '$http', '$q', '$compile', 'DTOptionsBuilder', 'DTColumnBuilder', 'SistemaConstanteValue',
        'ComunServicio', 'TablaFactory'];

    /* Funcion Principal. */
    function GestorTipoUsuarioControlador($rootScope, $scope, $uibModal, $state, $translate, $timeout,
        i18nFactory, $http,  $q, $compile, DTOptionsBuilder, DTColumnBuilder, SistemaConstanteValue,
        ComunServicio, TablaFactory) {
        ...
        vm.camposTablas     = TablaFactory.tablaTipoUsuario();
        ...
        vm.rutaPHP          = vm.paths.rcs.php.ruta + vm.paths.rcs.php.admTablaTipoUsuarios;
        vm.init             = inicializar;
         ...
         */
        vm.validar = function (){
            if (vm.txtUsuario !== "" && vm.txtDescripcion !== "" && vm.cmbEstado.length > 0 ) {
        ...
        function tablaAdministracionArea(){
            ...
            vm.dtAdministrarColumns = TablaFactory.contruirColumnasTabla(vm.camposTablas, "tipousuario");
        }
        ...
        function transferirMensaje() {
            var mensaje = i18nFactory.i18nTraduccion(vm.lbl.msj.mod.confirmartusuario) + vm.tipoUsuario + "  ?";
           return mensaje;
        }
