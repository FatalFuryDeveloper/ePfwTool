...
(function(angular) {
    ...
    angular.module('sri').controller('GestorNivelControlador',GestorNivelControlador);

    /* Parametros a inyectar en la Funcion Principal*/
    GestorNivelControlador.$inject = ['$rootScope', '$scope', '$uibModal', '$state', '$translate', '$timeout',
        'I18nFactory', '$http', '$q', '$compile', 'DTOptionsBuilder', 'DTColumnBuilder', 'SistemaConstanteValue',
        'ComunServicio','TablaFactory'];

    /* Funcion Principal. */
    function GestorNivelControlador($rootScope, $scope, $uibModal, $state, $translate, $timeout,
        i18nFactory, $http,  $q, $compile, DTOptionsBuilder, DTColumnBuilder, SistemaConstanteValue,
        ComunServicio,TablaFactory) {
        ...
        vm.camposTablas     = TablaFactory.tablaNivel();

        /* Variables para instanciar los campos de los formularios */
        buscarElementoHtml("#txtNivel").focus();
        vm.txtNivel         = "";
        vm.txtDescripcion   = "";
        vm.cmbEstado        = "";
        ...
        vm.rutaPHP          = vm.paths.rcs.php.ruta + vm.paths.rcs.php.admTablaNiveles;
        vm.init             = inicializar;
        ...
        function inicializar(){
            ...
            //$timeout(function(){consultarRegistros("vm.lbl.fun.consultar);},200);
            cargarCombos();
         ...
         */
        vm.validar = function (){
            if (vm.txtNivel !== "" && vm.txtDescripcion !== "" && vm.cmbEstado.length > 0 ) {
        ...
        function tablaAdministracion(){
            ...
            vm.dtAdministrarColumns = TablaFactory.contruirColumnasTabla(vm.camposTablas, "nivel");
        }
        ...
        function devolverLlamada() {
            $compile(angular.element("#tblAdministrarNivel" + "_length").contents())($scope);
        }
        ...
        function transferirMensaje() {
            var mensaje = i18nFactory.i18nTraduccion(vm.lbl.msj.mod.confirmarnivel) + vm.nivel + "  ?";
           return mensaje;
        }
        ...
        function borrarFiltros() {
            ...
            vm.txtDescripcion   = "";
            vm.cmbEstado        = "";
            vm.boton1           = vm.lbl.btnagregar;
            vm.boton2           = vm.lbl.btnlimpiar;
            vm.eliminado        = 0;
