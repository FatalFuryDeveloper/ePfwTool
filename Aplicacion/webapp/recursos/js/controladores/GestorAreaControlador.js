...
(function(angular) {
    ...
    function GestorAreaControlador($rootScope, $scope, $uibModal, $state, $translate, $timeout,
        ...
        vm.camposTablas     = TablaFactory.tablaArea();

        /* Variables para instanciar los campos de los formularios */
        buscarElementoHtml("#txtArea").focus();
        vm.txtArea          = "";
        vm.txtDescripcion   = "";
        vm.cmbEstado        = "";
        ...
        vm.rutaPHP          = vm.paths.rcs.php.ruta + vm.paths.rcs.php.admTablaAreas;
        vm.init             = inicializar;
         ...
         */
        vm.validar = function (){
            if (vm.txtArea !== "" && vm.txtDescripcion !== "" && vm.cmbEstado.length > 0 ) {
        ...
        function tablaAdministracionArea(){
            ...
            vm.dtAdministrarColumns = TablaFactory.contruirColumnasTabla(vm.camposTablas, "area");
        }
        ...
        function aceptar(){
            if(vm.guardar === true){
                ...
                actualizarRegistro(vm.lbl.fun.modificar,vm.lbl.msj.act.success,vm.lbl.msj.act.error);
            }
        }
        ...
        vm.cambiarEstado = function(id,estado){
            ...
            vm.cmbEstado        = estado;
            actualizarRegistro(vm.lbl.fun.cambiarestado,vm.lbl.msj.act.success,vm.lbl.msj.act.error);
        };
        ...
        /**
         * @description Funcion para insertar registro en tabla
         * @returns void
         */
        function insertarRegistro(funcion){
         ...
         /**
         * @description Funcion para actualizar registros de tabla
         * @returns void
         */
        function actualizarRegistro(funcion,alertaSuccess, alertaError){
            var datos = armarTrama(vm.lbl.tip.post,vm.rutaPHP,funcion);
            ejecutarServicio(datos,alertaSuccess,alertaError);
        }
        ...
        function abrirModal() {
            ...
            modalInstance.result.then(function () {
                vm.eliminado        = 1;
                actualizarRegistro(vm.lbl.fun.eliminar,vm.lbl.msj.eli.success,vm.lbl.msj.eli.error);
            });
        }
        ...
        function transferirMensaje() {
           var mensaje = i18nFactory.i18nTraduccion(vm.lbl.msj.mod.confirmararea) + vm.area + "  ?";
           return mensaje;
        }
        ...
        */
        ...
        /**
         * @description Funcion para borrar los campos del formulario
         * @returns void
         */
